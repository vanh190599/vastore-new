                        ...
                        <div class="wizard wizard-1" id="kt_wizard" data-wizard-state="first" data-wizard-clickable="false">
                            ...
                            <div class="wizard-nav border-bottom">
                                <div class="wizard-steps p-8 p-lg-10">
                                    <form action="{{ route('admin.account.search') }}" method="get">
                                        <div class="row">
                                            <div class="col-lg-4">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group fv-plugins-icon-container">
                                                    <label>Email</label>
                                                    <input type="text" class="form-control form-control-solid form-control-lg" name="email" placeholder="Email" value="{{ request('email') }}">
                                                    <div class="fv-plugins-message-container"></div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group fv-plugins-icon-container">
                                                    <label>Phone</label>
                                                    <input type="text" class="form-control form-control-solid form-control-lg" name="phone" placeholder="Số điện thoại" value="{{ request('phone') }}">
                                                    <div class="fv-plugins-message-container"></div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                            ...
                                            @if(!empty($admins))
                                                @foreach($admins as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ $value->avatar }}" width="50px" height="50px" alt="" style="object-fit: cover"></td>
