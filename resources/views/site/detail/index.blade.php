...
<div id="site-home">
    @if (isset($related) && count($related) > 0)
            <div style="text-align: center ;color: orangered; font-size: 18px; font-weight: 700; margin-top: 20px">SẢN PHẨM LIÊN QUAN</div>
            <br>
                                    ...
                                    <div class="box-config">
                                        <div class="config">
                                            <div style="margin-right: 10px; display: flex; align-items: center; height: 24px">
                                                <img src="{{ asset('eshoper/images/cpu.png') }}" width="18px" height="18px" class="icn-conf" alt="">&nbsp;
                                                <span>{{ $value->cpu }}</span>
                                            </div>

                                            <div style="margin-right: 10px; display: flex; align-items: center; height: 24px">
                                                <img src="{{ asset('eshoper/images/screen.png') }}" width="18px" class="icn-conf" height="18px" alt="">
                                                <span>{{ $value->size }}</span>
                                            </div>

                                            <div style="margin-right: 10px; display: flex; align-items: center; height: 24px">
                                                <img src="{{ asset('eshoper/images/ram.png') }}" width="18px" class="icn-conf" height="18px" alt="">&nbsp;
                                                <span>{{ $value->ram }}</span>
                                            </div>

                                            <div style="margin-right: 10px; display: flex; align-items: center; height: 24px">
                                                <img src="{{ asset('eshoper/images/storage.png') }}" width="18px" class="icn-conf" height="18px" alt="">&nbsp;
                                                <span>{{ $value->ram }}</span>
                                            </div>
