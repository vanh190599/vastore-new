                                        ...
                                        <div class="pb-0" data-wizard-type="step-content" data-wizard-state="current">
                                                ...
                                                <select name="brand_id" class="form-control form-control-solid form-control-lg">
                                                    @if(sizeof($brands) > 0)
                                                        @foreach($brands as $key => $value)
                                                            <option @if($product->brand_id == $key) selected @endif value="{{ $key }}">{{ $value }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group fv-plugins-icon-container">
                                                ...
                                                <div class="d-flex">
                                                    <input type="text" class="form-control form-control-solid form-control-lg"
                                                           ...
                                                           value="{{ old('unit_num', $product->unit_num) }}" style="width: 250px">
                                                    ...
                                                    <select name="unit_label" id="" class="form-control form-control-solid form-control-lg" style="width: 150px">
                                                        @if(count($aryLabel) > 0)
                                                            @foreach($aryLabel as $k => $v)
                                                                <option @if(old('unit_num', $product->unit_label) == $k) selected @endif value="{{ $k }}">{{ $v }}</option>
                                                            @endforeach
                                                        @endif
                                                    </select>
                                                </div>
                                            ...
                                            <div class="d-flex justify-content-between" >
                                                <div class="form-group fv-plugins-icon-container" style="width: 48%">
                                                    ...
                                                    <div class="d-flex">
                                                        <input name="tech_screen" value="{{ old('tech_screen', $product->tech_screen) }}"
                                                               class="form-control form-control-solid form-control-lg"
                                            ...
                                            <div class="d-flex justify-content-between" >
                                                <div class="form-group fv-plugins-icon-container" style="width: 48%">
                                                    ...
                                                    <div class="d-flex">
                                                        <input name="cpu" value="{{ old('cpu', $product->cpu) }}" class="form-control form-control-solid form-control-lg"
                                                               placeholder="cpu">
                                                    </div>
                                                    @error('cpu')
                                                    <div class="text-danger">{{ $message }}</div>
                                            ...
                                            <div class="d-flex justify-content-between" >
                                                <div class="form-group fv-plugins-icon-container" style="width: 48%">
                                                    ...
                                                    <div class="d-flex">
                                                        <input name="rom" value="{{ old('rom', $product->rom) }}" class="form-control form-control-solid form-control-lg"
                                            ...
                                            <div class="d-flex justify-content-between" >
                                                <div class="form-group fv-plugins-icon-container" style="width: 48%">
                                                    ...
                                                    <div class="d-flex">
                                                        <input name="camera_before" value="{{ old('camera_before', $product->camera_before) }}"
                                                               class="form-control form-control-solid form-control-lg"
                                                ...
                                                <div class="form-group fv-plugins-icon-container" style="width: 48%">
                                                    ...
                                                    <input type="text" class="form-control form-control-solid form-control-lg"
                                                           ...
                                                           value="{{ old('camera_after', $product->camera_after ) }}" >
                                                    @error('camera_after')
                                                    <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                    <div class="text-danger"></div>
