                        ...
                        <div class="wizard wizard-1" id="kt_wizard" data-wizard-state="first" data-wizard-clickable="false">
                            ...
                            <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                                <div class="col-xl-12 col-xxl-7">
                                    <!--begin::Wizard Form-->
                                    <form action="{{ route('admin.account.edit', ['id' => $admin->id]) }}" class="form fv-plugins-bootstrap fv-plugins-framework" method="POST"  id="kt_form">
                                    @csrf
                                    <!--begin::Wizard Step 1-->
...
{{--                                            </div>--}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="status" id="" class="form-control form-control-solid form-control-lg">
                                                    @if(!empty($aryStatus))
                                                        @foreach($aryStatus as $k => $v)
                                                            <option @if(old('status', $admin->status) == $k) selected  @endif value="{{$k}}">{{$v}}</option>
                                                        @endforeach
                                                    @endif
