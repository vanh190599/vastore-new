                        ...
                        <div class="wizard wizard-1" id="kt_wizard" data-wizard-state="first" data-wizard-clickable="false">
                            ...
                            <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                                <div class="col-xl-12 col-xxl-7">
                                    <!--begin::Wizard Form-->
                                    <form action="{{ route('admin.news.create') }}" class="form fv-plugins-bootstrap fv-plugins-framework" method="POST"  id="kt_form">
                                    @csrf
                                    <!--begin::Wizard Step 1-->
                                        <div class="pb-0" data-wizard-type="step-content" data-wizard-state="current">
                                            ...
                                            <div class="form-group fv-plugins-icon-container">
                                                ...
                                                <input type="text" required class="form-control form-control-solid form-control-lg" name="title" placeholder="Nhập tên thương hiệu" value="{{ old('name') }}">
                                                @error('name')
                                                ...
                                                <select type="text" required class="form-control form-control-solid form-control-lg" name="category_news_id">
                                                    @if(!empty($cate))
                                                        @foreach($cate as $key => $value)
                                                            <option @if(old('category_news_id') == $value->id) selected @endif value="{{ $value->id }}">{{ $value->name }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea required name="description" id="" class="form-control form-control-solid" cols="30" rows="10" placeholder="Mô tả"></textarea>
                                                @error('description')
                                                <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <img id="img" class="d-none" src="" alt="" width="100px" height="100px" style="object-fit: cover">
                                            <br>
